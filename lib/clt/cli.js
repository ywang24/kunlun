...
if(argv._[0] === 'init') {
  ...
  Inquirer.prompt( questions, function( answers ) {
    ...
    Exec('npm install appium-plus appium q saucelabs config mocha testarmada-magellan testarmada-magellan-mocha-plugin --save', function (error, stdout, stderr) {
      if (error !== null) {
        console.log('npm install failed: ' + error);
        console.log('Please try appium-plus init again');
      } else {
        console.log('\n================================================================');
        console.log('Basic Appium test framework was created successfully!');
        console.log('\nYou can start to update/add your modules as in lib/module/');
